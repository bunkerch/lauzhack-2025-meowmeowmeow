...
export async function verifyProofOffline(
  ...
  try {
    console.log('🔐 Verifying ZK proof with snarkjs...');
...
export async function verifyTicketOffline(ticketData: QRCodeData): Promise<{
  ...
  console.log('  → Step 1: Verifying ZK proof with snarkjs...');
  ...
  console.log('  → Step 2: Checking validity period...');
  ...
  console.log('  ✓ Ticket is within validity period');

  // All checks passed!
  console.log('✅ Offline verification complete - ticket is VALID!');
